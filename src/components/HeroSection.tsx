        ...
        delay: 0.4
          ...
          <div className="relative w-full max-w-md mx-auto">
            ...
            <div className="relative aspect-square overflow-hidden">
              ...
              <img alt="Geethika Isuru" data-speed-x="5" data-speed-y="-3" src="/img/73dc8931-7f0c-4216-a3bb-3c6eba7ad90f.png" className="w-full h-full object-cover object-center transform" />
            </div>
          </div>
        </motion.div>
      </div>
