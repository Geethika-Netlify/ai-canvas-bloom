        ...
        {isOpen && (
          ...
          >
            ...
            <form
              ...
              className="border-t border-border p-3 flex items-center space-x-2"
            >
              <input
                type="text"
                value={inputValue}
                ...
                className="flex-1 bg-muted/50 border border-border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                disabled={isLoading}
              />
              <Button
                type="submit"
